...
function Blog() {
    ...
    return (
        <>
            ...
            <h2 className="lale  mr-20 text-3xl mt-25 after:content-[''] after:block after:w-50 after:h-1 after:bg-[#f3cf7a] after:absolute after:-bottom-36 after:right-20"> محصولات پر فروش این هفته</h2>
            <div className="flex flex-col md:flex-row  mt-10 p-5 g-5 ">

                <Card className="max-w-sm md:w-[900px] md:ml-3 mt-5" imgSrc={latte} horizontal>
                    ...
                    <p className="yekan font-normal text-gray-700  dark:text-gray-400">
                        اسپرسو ۱–۲ شات + شیر بخارخورده  + میکروفوم
                    </p>
                    <Rating>
                        <RatingStar />
                        <RatingStar />
                ...
                <Card className="max-w-sm md:w-[900px] md:ml-3 mt-5" imgSrc={iceam} horizontal>
                    <h5 className="lale text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        آیس آمریکانو (Iced Americano)
                    </h5>
                    <p className="font-normal text-gray-700 dark:text-gray-400">
                        اسپرسو ۲ شات + آب سرد   + یخ
                    </p>
                    <Rating>
                        <RatingStar />
                        <RatingStar />
                ...
                <Card className="max-w-sm md:w-[900px] md:ml-3 mt-5" imgSrc={icecara} horizontal>
                    <h5 className="lale text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        آیس کارامل ماکیاتو (Iced Caramel Macchiato)
                    </h5>
                    <p className="font-normal text-gray-700 dark:text-gray-400">
                        شربت وانیل  + شیر سرد   + یخ ۶–۸ قطعه + اسپرسو  + سس کارامل
                    </p>
                    <Rating>
                        <RatingStar />
                        <RatingStar />
            ...
            <h2 className="lale  mr-20 text-3xl mt-25 after:content-[''] after:block after:w-35 after:h-1 after:bg-[#f3cf7a] after:absolute after:-bottom-147 after:right-20">جایزه های نفیس ما  </h2>
            ...
            <div className="mb-6 grid md:mt-6 md:p-5 grid-cols-4 gap-2 text-center">
                {countdownBoxes.map((i) => (
                    <div key={i.label} className="rounded-xl border border-[#f3cf7a] bg-[#f3cf7a] py-3">
                        <div className="text-2xl text-[#774e26]   font-bold tabular-nums lale">{String(i.val).padStart(2, "0")}</div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center p-10">
                <div className="m-auto w-full md:w-1/2">
                    <div className="flex justify-between text-xs text-gray-600 mb-1 lale">
                ...
                <div className=" w-full  mt-10 md:w-1/2 md:mr-10">
                    <Accordion>
                        <AccordionPanel>
                            ...
                            <AccordionContent>
                                <p className="text-gray-500 dark:text-gray-400 yekan">
                                    هر خرید = ۱ شانس. کد روی رسید را در حساب ثبت کنید.
                                </p>
                            </AccordionContent>
                        </AccordionPanel>
                        <AccordionPanel>
                            <AccordionTitle className="lale">علام نتایج چه زمانی است؟</AccordionTitle>
                            <AccordionContent>
                                <p className="mb-2 text-gray-500 dark:text-gray-400 yekan">
                                    پس از اتمام شمارش‌معکوس، جمعه ساعت ۲۰:۰۰.
                                </p>
                            </AccordionContent>
                        </AccordionPanel>
                        <AccordionPanel>
                            ...
                            <AccordionContent>
                                <p className="mb-2 text-gray-500 dark:text-gray-400 yekan">
                                    در هر روز حداکثر ۵ کد می‌توانید ثبت کنید.
                                </p>
                            </AccordionContent>
                        </AccordionPanel>
                    </Accordion>
            ...
            <div className="flex flex-col md:flex-row md:mt-20 p-5">
                <div className=" w-[50%] mx-auto overflow-x-auto">
                    <Table hoverable>
                        ...
                        <TableBody className="divide-y yekan">
                    ...
                    <a className=" text-blue-600 hover:border-b hover:border-blue-600 cursor-pointer lale md:mr-130">  مشاهده برندگان هفته گذشته </a>
                </div>
