...
function Aboutus() {
  return (
    <>
      {/* لایه‌ی سراسری: رنگ‌ها از توکن‌ها */}
      <div className="bg-[color:var(--bg)] text-[color:var(--text)]">
        {/* هیرو با تصویر؛ متن سفید برای خوانایی */}
        ...
        <div className="pt-[100px]">
          <div className="w-full flex flex-col lg:flex-row items-center justify-around gap-3 p-4">
            ...
            <div className="w-full mt-[-60px] lg:w-[50%]">
              <Accordion>
                <AccordionPanel>
                  ...
                  <AccordionContent>
                    <p className="mb-2 yekan text-[color:var(--text)]/70">
              ...
              <Accordion className="mt-[100px]">
                ...
                <AccordionPanel>
                  ...
                  <AccordionContent>
                    <p className="mb-2 yekان text-[color:var(--text)]/70">
            ...
            <div className="w-full lg:w-[400px] flex flex-col gap-4 p-3 justify-center items-center">
              <img className="w-full rounded-2xl border border-[color:var(--border)]" src={about1} alt="" />
              <img className="w-full rounded-2xl border border-[color:var(--border)]" src={about2} alt="" />
            </div>
          </div>

          {/* متن معرفی طولانی */}
          <div className="w-full mt-2 p-5 lale text-2xl text-[color:var(--text)]/80">
            <p>
              کافه « لاما لته »، جایی فراتر از یک محل نوشیدن قهوه، پناهگاهی گرم و دلنشین برای تمام لحظات شبانه‌روز است. این کافه با فضایی مدرن و در عین حال صمیمی، میزبان افرادی است که به دنبال تجربه‌ای متفاوت از طعم و آرامش هستند. نورهای ملایم، موسیقی آرام، و رایحه دل‌انگیز قهوه تازه‌دم، اولین چیزی است که با ورود به اینجا حس می‌کنید.
              <br /><br />
              ...
              <br /><br />
              در «لاما لته»، ساعت هیچ معنایی ندارد؛ هر زمان که قدم بگذارید، عطر قهوه و لبخند کارکنان در انتظار شماست.
            </p>
          </div>

          {/* تیم ما */}
          <div className="w-full mt-4">
            <h2 className="lale text-3xl pr-10 pt-5 relative after:content-[''] after:block after:w-15 after:h-1 after:bg-[#f3cf7a] after:absolute after:-bottom-2 after:right-10">
              تیم ما
            </h2>

            <div className="flex flex-col lg:flex-row lg:g-3 items-center justify-around p-10">
              <Card
                className="max-w-sm mt-8 relative bg-[color:var(--card)] border border-[color:var(--border)]"
              ...
              >
                ...
                <h5 className="lale text-2xl font-bold tracking-tight text-[color:var(--text)]">مهدی عسگری</h5>
                <p className="yekan text-[color:var(--text)]/70">
              ...
              >
                ...
                <h5 className="text-2xl font-bold tracking-tight lale text-[color:var(--text)]">کژال محمدی</h5>
                <p className="yekan text-[color:var(--text)]/70">
              ...
              >
                ...
                <h5 className="text-2xl font-bold tracking-tight lale text-[color:var(--text)]">مرتضی مقدسی</h5>
                <p className="yekan text-[color:var(--text)]/70">
